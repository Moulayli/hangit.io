...
const Player = {
	...
	Return = {
		tip: {
			...
			finishedGame: "🚪 L'hébergeur a terminé la partie.<br><a href='https://moulayli.github.io/hangit.io/'>Actualisez la page</a> pour en commencer une nouvelle."
		},
...
// Restart game
Button.restart.addEventListener("click", () => {location.href = "https://moulayli.github.io/hangit.io/"});
